...
def collaborators():
    with st.chat_message("user"):
        ...
        c1, c2 = st.columns(2)
        with c1:
            text = """As some of you may already know, I’m planning to start my own company. One of my main goals is to create opportunities and provide experience to those who may not have access to it. I’m currently in the ideation stage, so there’s no funding YET, but the idea is COOL, if I do say so myself and 
                    I would be fully transparent about the company’s financial situation with founding members.
                    Right now, I’m developing the app and looking for collaborators to help launch it. It’s a low-commitment opportunity, and I’m sharing this by the off chance it might align with your future goals — for example, if you want to go into brand marketing be the HEAD OF MARKETING for my startup. We could really create any role, provided it helps get the company off the ground!
                   ...
                   """
            st.write(f'<p style="font-size: 11px; color:grey; text-align: justify;">{text}</p>',
